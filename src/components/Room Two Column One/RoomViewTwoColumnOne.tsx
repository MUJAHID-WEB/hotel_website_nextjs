...
import RoomsComponentTwo from "../common/RoomComponentTwo";

function RoomViewTwoColumnOne() {
  const roomsArr = [
    {
  ...
  return (
    <div className="container my-[75px] xl:px-0 lg:px-1.5 sm:px-1 md:px-[30px] px-5 ">
      <div className="flex flex-col items-center lg:flex-row lg:items-start lg:justify-between">
        <RoomsComponentTwo dataTwo={roomsArr} />
...
export default RoomViewTwoColumnOne;
